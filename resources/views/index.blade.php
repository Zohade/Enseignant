...
<body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Minsihoue</a>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">La maison de l'Enseignant</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Une communauté de partage de ressources entre enseignant du primaire
                        au Bénin.</p>
                    <a class="btn btn-primary btn-xl" href="{{ route('login') }}">Commencer</a>
                </div>
            </div>
        </div>
    </header>
